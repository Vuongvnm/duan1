<footer class="section-p1">
  ...
  <div class="col">
    <h4><strong>Về BusyBees</strong></h4>
    <a href="index.php?action=gioi_thieu">Giới thiệu</a>
    <a href="index.php?action=gio_hang">Thông tin đặt hàng</a>
    <a href="index.php?action=chinh_sach_bao_mat">Chính sách bảo mật</a>
    <a href="index.php?action=thong_tin_va_dieu_khoan">Thông tin và điều khoản</a>
  ...
  <div class="col">
    ...
    <a href="index.php?action=bai_viet">Bài viết</a>
    <a href="index.php?action=tro_giup">Trợ giúp</a>
